...
class CustomizedNumberPicker extends StatelessWidget {
  ...
  CustomizedNumberPicker.integer({
    Key key,
    @required int initialValue,
    @required this.minValue,
    @required this.maxValue,
  ...
  CustomizedNumberPicker.decimal({
    Key key,
  ...
  int _intValueFromIndex(int index) {
    index = index - (numberToDisplay~/2); //index--; //for extra elements. 3=>1, 7=>3	    index %= integerItemCount;
...
class _NumberPickerDialogControllerState extends State<NumberPickerDialog> {
  ...
  CustomizedNumberPicker _buildNumberPicker() {
    if (widget.decimalPlaces > 0) {
      return CustomizedNumberPicker.decimal(
      ...
      return CustomizedNumberPicker.integer(
